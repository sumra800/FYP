...
const Footer = ({ onNavigateToAbout, onNavigateToFeatures, onNavigateToContact, onNavigateToLanding, onNavigateToSignup, onNavigateToLogin }) => {
  return (
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-section">
          <div className="footer-logo" onClick={onNavigateToLanding} style={{cursor: 'pointer'}}>
